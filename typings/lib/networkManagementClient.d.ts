...
declare class NetworkManagementClient extends msRestAzure.AzureServiceClient {
     ...
     */
    checkDnsNameAvailabilityWithHttpOperationResponse(location: string, domainNameLabel: string, options?: msRest.RequestOptionsBase): Promise<msRest.HttpOperationResponse>;
    /**
     * Checks whether a domain name in the cloudapp.azure.com zone is available for
     * use.
     *
